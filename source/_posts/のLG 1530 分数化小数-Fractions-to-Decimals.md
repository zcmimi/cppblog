...
html: '<details><summary>查看原题</summary><div id=''from''></div><p><button onclick="document.getElementById(''from'').innerHTML=''<iframe
  src=&quot;https://www.luogu.com.cn/problem/P1530&quot; width=100% height=800px style=&quot;border:
  none;&quot;><iframe>''" class=''mdui-btn mdui-btn-raised mdui-ripple''>点击加载</button><a
  class=''mdui-btn mdui-btn-raised mdui-ripple'' href="https://www.luogu.com.cn/problem/P1530"
  target=''_blank''>点击跳转</a><p></details>'
permalink: LG 1530 分数化小数-Fractions-to-Decimals
tags:
- 模拟
thumbnail: null
title: LG 1530 分数化小数-Fractions-to-Decimals
top: 0
---
```cpp
#include<bits/stdc++.h>
